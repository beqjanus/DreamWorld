...
http://127.0.0.1/T2S/tts.plx?&APIKey=123&TTS=Hello

If your Apache port is not  80, you must add it:
http://127.0.0.1:80/T2S/tts.plx?&APIKey=123&TTS=Hello

Speak Default Voice out of the server speakers. The HTTP responses is a 200 OK and "Spoken"
http://192.168.2.139/T2S/tts.plx?&APIkey=123&Speak=1&TTS=Hello

Use Ziras voice to say 1 2 3 4 5 
http://127.0.0.1/T2S/tts.plx?TTS=test 1 2 3 4 5&Voice=Zira&APIKey=123

Force a Male voice to say A B C D
http://127.0.0.1/T2S/tts.plx?TTS=A B C D&APIKey=123&Sex=M

Force a Male voice to say A B C D
http://127.0.0.1/T2S/tts.plx?TTS=M:A B C D&APIKey=123

Force a Feale voice to say A B C D E
http://127.0.0.1/T2S/tts.plx?TTS=F:A B C D E&APIKey=123
...
my $debug = 1; # set to any value but 0 to be able to test parts of it.
