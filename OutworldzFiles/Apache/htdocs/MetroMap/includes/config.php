<?php 
/* General Domain */
$CONF_domain        = "test.outworldz.net"; 
$CONF_port          = "8002"; 
$CONF_sim_domain    = "http://test.outworldz.net/";
...
$CONF_center_coord_x = "948";		// the Center-X-Coordinate 
$CONF_center_coord_y = "909";		// the Center-Y-Coordinate 
// style-sheet items
