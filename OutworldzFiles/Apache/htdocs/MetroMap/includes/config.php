<?php 
/* General Domain */
$CONF_domain        = "smartyboot.outworldz.net"; 
$CONF_port          = "8002"; 
$CONF_sim_domain    = "http://smartyboot.outworldz.net/";
...
$CONF_center_coord_x = "1017";		// the Center-X-Coordinate 
$CONF_center_coord_y = "1004";		// the Center-Y-Coordinate 
// style-sheet items
