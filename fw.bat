...
netsh advfirewall firewall  delete rule name="Apache HTTP Web Port 8080"
...
netsh advfirewall firewall  add rule name="Apache HTTP Web Port 8080" dir=in action=allow protocol=TCP localport=8080
