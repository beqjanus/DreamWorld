...
netsh advfirewall firewall delete rule name="Region TCP Port 8006"
netsh advfirewall firewall delete rule name="Region UDP Port 8006"
...
netsh advfirewall firewall add rule name="Region TCP Port 8006" dir=in action=allow protocol=TCP localport=8006
netsh advfirewall firewall add rule name="Region UDP Port 8006" dir=in action=allow protocol=UDP localport=8006
